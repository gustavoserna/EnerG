...
<head>
  <meta charset="utf-8">
  <title>Vitallica - Inicia sesión</title>
    ...
    <section id="contact" class="section-bg wow fadeInUp">
      ...
      <div class="container">
        ...
        <div class="section-header">
          <br><br><br><br><h2>Iniciar sesión</h2>
          <p>Ingresa a tu cuenta para poder ver tus clases programadas y completadas.</p>
        </div>

        <div class="form">
          <div id="sendmessage">Login</div>
          <div id="errormessage">Usuario o contraseña incorrectos</div>
          <form id="login-form" action="" method="post" role="form" class="contactForm">
            ...
            <div class="text-center"><button type="submit">Iniciar sesión</button></div><br>
            <div class="text-center"><hr class="col-md-6" /></div>
            <div class="text-center"><p><a href="registro.php">Crea una cuenta ahora</a></p></div><br>
          </form>
        </div>
